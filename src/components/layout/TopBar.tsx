  ...
  return (
    <div className="safe-top relative z-30 px-4 pt-3 pb-2">
      ...
      <div className="flex items-center gap-2">
        ...
        {title && (
          <h1 className="max-w-[12rem] truncate text-base font-black text-white">
            {title}
          </h1>
        )}
      </div>
      ...
      <div ref={menuRef} className="relative">
        ...
        {open && (
          <div
            className="absolute right-0 top-full mt-2 w-60 overflow-hidden rounded-2xl border border-white/10 bg-[#071225] shadow-2xl shadow-black/40"
            role="menu"
          >
            <div className="border-b border-white/10 px-3 py-3">
              <p className="text-[10px] font-semibold uppercase tracking-widest text-green-300/80">
                Signed in
              </p>
